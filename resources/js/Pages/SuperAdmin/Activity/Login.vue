...
<template>
    <DashboardLayout :title="__('login activities')">
        <Card class="bg-white dark:bg-gray-700 dark:text-gray-200">
            ...
            <template #body>
                <Builder :url="route('super_admin.activity.login')">
                    ...
                    <template #tbody="{ data }">
                        ...
                        >
                            ...
                            >
                                <td
                                    class="px-2 py-1 border border-inherit text-center"
                                >
                                    {{ i + 1 }}
                                </td>

                                <td
                                    class="px-2 py-1 border border-inherit uppercase"
                                >
                                    {{ activity.name }}
                                </td>
