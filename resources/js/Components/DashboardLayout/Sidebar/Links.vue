    ...
    <div class="w-full flex flex-col">
        ...
        >
            <div class="flex items-center justify-center space-x-2">
                ...
                <template v-if="open">
                    <p class="uppercase font-semibold w-full text-left">
                        {{ __(menu.name) }}
                    </p>
                    ...
                    <div class="flex items-center space-x-2">
                        <div
                            v-if="counter > 0"
                            ref="element"
                            class="flex items-center justify-center bg-red-500 text-white text-center rounded-full p-1"
                        >
                            <p class="text-xs">
                                {{ counter }}
                            </p>
